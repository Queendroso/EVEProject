...
After browser step, come back here (RStudio) and run gitcreds::gitcreds_set() to store it.
...
## 7) Add a README in R Markdown (README.Rmd) and render it to README.md (ensure that the YAML header in the README.Rmd for the output reads github_document)
